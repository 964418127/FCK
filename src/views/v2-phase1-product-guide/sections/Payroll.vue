      ...
      <div id="payroll" class="section">
        ...
        <div class="card">
          ...
          <div class="note">
            ...
            <strong>常乐豆抵扣范围：</strong>常乐豆<strong>只抵扣公积金公司部分</strong>（<strong>公司部分由老系统记账</strong>，<strong>不进员工工资条</strong>），<strong>不抵扣公积金个人部分、不抵扣社保/商业险</strong>。公积金<strong>个人部分</strong>由<strong>员工足额自行交纳</strong>，工资条上保留「代扣公积金」扣减项（金额从老系统读取），<strong>与常乐豆无关</strong>。<br/>
            <strong>商业险：</strong>默认机制，<strong>不进工资条</strong>，<strong>不显示</strong><br/>
            <strong>离职常乐豆：</strong>全职员工离职时，优先完成当期<strong>公积金公司部分</strong>的抵扣，<strong>最终剩余的常乐豆余额全部提现</strong>
          </div>
        </div>
          ...
          <table class="data-table">
            ...
            <tbody>
              <tr>
                ...
                <td>返聘<strong>无常乐豆</strong>，<strong>无公积金代扣</strong>（<strong>无个人部分</strong>，达到退休年龄不再缴纳）；商业险<strong>默认机制（不显示）</strong></td>
              </tr>
            </tbody>
          </table>
          <div class="note" style="background: hsl(var(--muted) / 0.3);">
            <strong>说明：</strong>返聘工资单结构最简，<strong>实际可灵活配置任意数量工资条</strong>。返聘场景下<strong>无常乐豆</strong>、<strong>无公积金代扣</strong>（达到退休年龄不再缴纳）；商业险<strong>默认机制（不进工资条）</strong>。
          </div>
        </div>
