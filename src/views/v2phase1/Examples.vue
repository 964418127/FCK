  ...
  >
    <div id="examples" class="section">
      <h2>七、计算示例</h2>
        ...
        <!-- 全职示例 A -->
        <div class="card">
          <h3 id="ex-1">全职示例 A：常乐豆<strong>充足（覆盖公司+部分个人）</strong> → 抵公司 1200，剩余抵个人 800，触发「绩效补贴」800（含负工资抵扣）</h3>
          <div class="example">
        ...
        <!-- 全职示例 B -->
        <div class="card">
          <h3 id="ex-2">全职示例 B：常乐豆<strong>不足抵公司部分</strong> → 公司部分差额由公司现金补足，<strong>无剩余抵个人部分</strong>，<strong>不触发「绩效补贴」</strong>（含负工资抵扣）</h3>
          <div class="example">
            <p><strong>员工当月数据：</strong></p>
            <table class="data-table">
              <thead>
        ...
        <!-- 全职示例 C：常乐豆正好够公司部分 -->
        <div class="card">
          <h3 id="ex-3">全职示例 C：常乐豆<strong>正好够抵公司部分</strong> → 公司部分 1200 全部由常乐豆抵扣，<strong>无剩余抵个人部分</strong>，<strong>不触发「绩效补贴」</strong>（员工个人 1200 全自付）</h3>
          <div class="example">
            <p><strong>员工当月数据：</strong></p>
            <table class="data-table">
              <thead>
...
const tocItems = [
    { id: 'ex-1', label: '全职示例 A：常乐豆<strong>充足（覆盖公司+部分个人）</strong> → 抵公司 1200，剩余抵个人 800，触发「绩效补贴」800（含负工资抵扣）' },
    { id: 'ex-2', label: '全职示例 B：常乐豆<strong>不足抵公司部分</strong> → 公司部分差额由公司现金补足，<strong>无剩余抵个人部分</strong>，<strong>不触发「绩效补贴」</strong>（含负工资抵扣）' },
    { id: 'ex-3', label: '全职示例 C：常乐豆<strong>正好够抵公司部分</strong> → 公司部分 1200 全部由常乐豆抵扣，<strong>无剩余抵个人部分</strong>，<strong>不触发「绩效补贴」</strong>（员工个人 1200 全自付）' },
