...
const tocItems = [
    { id: 'calc-1', label: '全职（劳动合同）' },
    { id: 'calc-2', label: '非全日制（劳务协议）' },
    { id: 'calc-3', label: '兼职（劳务合作）' },
    { id: 'calc-4', label: '返聘（劳务合作-退休返聘）' }
  ]
