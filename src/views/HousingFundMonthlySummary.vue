<template>
  <div class="housing-fund-monthly-summary">
    <div class="page-header">
      <h1>公积金月度汇总</h1>
      <p class="tip">💡 查看员工公积金每月缴纳汇总，含正常、补缴、退缴的合计金额</p>
    </div>
...
const goToDetail = () => {
  router.push({ name: 'housing-fund-monthly-record' })
}

const goToDetailRow = (row) => {
  router.push({ name: 'housing-fund-monthly-record', query: { employeeId: row.employeeId, month: row.month } })
}
</script>

<style scoped>
.housing-fund-monthly-summary { padding: 0; }
