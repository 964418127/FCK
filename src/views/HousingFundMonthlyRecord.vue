<template>
  <div class="housing-fund-monthly-record">
    <div class="page-header">
      <h1>公积金月度流水明细</h1>
      <p class="tip">💡 查看每条公积金缴纳记录的流水明细，支持筛选和手动导入</p>
    </div>
...
const handleSubmit = () => {
  ...
  const grade = { E001: '2', E002: '2', E003: '3' }[form.employeeId]
  if (isEdit.value) {
...
<style scoped>
.housing-fund-monthly-record { padding: 0; }
