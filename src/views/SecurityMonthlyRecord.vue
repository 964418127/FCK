...
const records = ref([
  // 社保记录（全职单主体，1 合同主体 = 1 申报主体）
  { id: 1, employeeId: 'E001', employeeName: '张三', declarationEntity: '北京推拿公司', store: '北京旗舰店', grade: '3', feeType: '社保', baseAmount: 8000, actualAmount: 800, generateMonth: '2026-01', attrributionMonth: '2026-01', paymentMonth: '2026-02', recordType: '正常', dataSource: '三方服务', adjustReason: '', createTime: '2026-01-31 10:00:00' },
  { id: 2, employeeId: 'E001', employeeName: '张三', declarationEntity: '北京推拿公司', store: '北京旗舰店', grade: '3', feeType: '社保', baseAmount: 8000, actualAmount: 800, generateMonth: '2026-02', attrributionMonth: '2026-02', paymentMonth: '2026-02', recordType: '正常', dataSource: '三方服务', adjustReason: '', createTime: '2026-02-28 10:00:00' },
  { id: 3, employeeId: 'E001', employeeName: '张三', declarationEntity: '北京推拿公司', store: '北京旗舰店', grade: '3', feeType: '社保', baseAmount: 8000, actualAmount: 20, generateMonth: '2026-02', attrributionMonth: '2026-02', paymentMonth: '2026-02', recordType: '补缴', dataSource: '三方服务', adjustReason: '基数调整补缴', createTime: '2026-02-28 10:05:00' },
  { id: 4, employeeId: 'E001', employeeName: '张三', declarationEntity: '北京推拿公司', store: '北京旗舰店', grade: '3', feeType: '滞纳金', baseAmount: 0, actualAmount: 50, generateMonth: '2026-01', attrributionMonth: '2026-01', paymentMonth: '2026-03', recordType: '正常', dataSource: '三方服务', adjustReason: '社保逾期未缴产生滞纳金', createTime: '2026-03-10 10:00:00' },
  { id: 8, employeeId: 'E003', employeeName: '王五', declarationEntity: '深圳推拿公司', store: '深圳总店', grade: '4', feeType: '社保', baseAmount: 10000, actualAmount: 1000, generateMonth: '2026-01', attrributionMonth: '2026-01', paymentMonth: '2026-01', recordType: '正常', dataSource: '手动导入', adjustReason: '三方未返回，手动导入', createTime: '2026-02-03 09:00:00' }
  // 注：李四（兼职）没有社保
  // 注：feeType='公积金'/'个税' 的记录不应出现在社保月度流水，应分别在 公积金月度流水/个税月度流水
])
