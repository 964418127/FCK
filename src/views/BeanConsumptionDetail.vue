<template>
  <div class="bean-consumption-detail">
    <el-card class="box-card">
      ...
      <div class="search-section">
        <el-form :inline="true" class="demo-form-inline">
          ...
          <el-form-item label="消费单号">
            <el-input v-model="searchForm.consumptionNo" placeholder="请输入消费单号" />
          </el-form-item>
          <el-form-item label="消费发起时间">
            <el-date-picker
          ...
          <el-form-item label="消费状态">
            <el-select v-model="searchForm.status" placeholder="请选择消费状态" style="width: 150px;">
              <el-option label="冻结" value="frozen" />
              <el-option label="消费成功" value="success" />
              <el-option label="消费失败" value="failed" />
            </el-select>
          </el-form-item>
          ...
          <el-form-item label="退货状态">
            <el-select v-model="searchForm.refundStatus" placeholder="请选择退货状态" style="width: 150px;">
      ...
      <el-table :data="consumptionList" style="width: 100%">
        ...
        <el-table-column prop="consumptionNo" label="消费单号" width="200" />
        ...
        <el-table-column prop="consumptionAmount" label="消费数量" width="120" />
        ...
        <el-table-column prop="initiateTime" label="消费发起时间" width="180" />
        <el-table-column prop="completeTime" label="消费完成时间" width="180" />
        <el-table-column prop="consumptionAmount" label="交易数量" width="120" />
        <el-table-column prop="status" label="消费状态" width="120">
          <template #default="scope">
...
const consumptionList = ref([
  {
    ...
    afterBalance: 800,
    accountType: 'balance',
    initiateTime: '2026-03-03 10:00:00',
    completeTime: '2026-03-03 10:05:00',
    status: 'success'
  },
  {
    month: '2026-03',
    consumptionNo: 'CON2026030002',
    name: '李四',
    department: '市场部',
    position: '市场专员',
    employeeId: '1002',
    ...
    afterBalance: 650,
    accountType: 'balance',
    initiateTime: '2026-03-03 11:00:00',
    completeTime: '2026-03-03 11:03:00',
    status: 'success'
  },
  {
    month: '2026-03',
    consumptionNo: 'CON2026030003',
    name: '王五',
    department: '销售部',
    position: '销售经理',
    employeeId: '1003',
    ...
    afterBalance: 1000,
    accountType: 'balance',
    initiateTime: '2026-03-03 14:00:00',
    completeTime: '2026-03-03 14:02:00',
    status: 'success'
  },
  {
    month: '2026-03',
    consumptionNo: 'CON2026030004',
    name: '赵六',
    department: '服务部',
    position: '推拿师',
    employeeId: '1004',
